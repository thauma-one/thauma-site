...
export const BEHAVIOUR_JS = [
  ...
  "  /* And the other end of the same question. A host column wide enough for",
  "     a two-column form should get one — the contact widget has a message",
  "     box, and 480px of it is a lot of scrolling to read back what you",
  "     wrote. The class is set here because measuring the container is this",
  "     function's job; what to DO with the room is each widget's own CSS, so",
  "     the sign-up form is unaffected by it. */",
  "  card.classList.toggle('wide', w >= 620);",
  "}",
  "",
